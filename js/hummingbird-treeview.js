...
(function($){
	...
	$.fn.runHummingBirdConverter = function(treeviewObject, converter_num){

		
	//var all_converter = $(".hummingbird-treeview-converter");
	//console.log(all_converter);
	var all_converter = treeviewObject.parent().find("div.hummingbird-treeview-converter");
	//var converter_num = 1;
	var converter_str = "";
	$.each(all_converter,function(e){
	//if(treeviewObject.hasClass("hummingbird-treeview-converter")){
	    if (converter_num > 1) {
	...
	if (typeof(methodName) == "undefined" ) {
		...
		$.each(all_labels_to_set_color, function(){
			...
			$( this ).css({'background':"none", 'color':forground_text_color});
		});
